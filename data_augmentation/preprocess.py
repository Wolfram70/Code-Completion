        ...
        try:
            ...
            for toknum, tokval, _, _, _ in token_gen:
                ...
                if toknum == STRING:
                    ...
                    prev_eol = False
                elif toknum in [COMMENT, ENCODING, INDENT, ENDMARKER] or len(tokval) == 0: #ignoring indent? (now added the previous check)
                    continue
                else:
...
def main():
    ...
    parser.add_argument("--base_dir", default="experiment_data", type=str, 
                        help="The downloaded data path")
    parser.add_argument("--output_dir", default="pre-processed", type=str, 
    ...
    py_tokenize(args, file_name="test.txt", file_type="train")
